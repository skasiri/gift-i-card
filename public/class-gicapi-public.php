...
class GICAPI_Public
{
    ...
    public function __construct($plugin_name, $version)
    {
        ...
        // New hooks for displaying gift card information
        add_action('woocommerce_before_order_itemmeta', array($this, 'display_gift_card_info_for_item'), 10, 3);
        add_action('woocommerce_order_details_after_order_table', array($this, 'display_gift_card_summary'));
    }
