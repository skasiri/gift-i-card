...
<div id="display" class="tab-content" style="display: none;">
    <table class="form-table">
        <tr>
            <th scope="row">
                <?php esc_html_e('Add to Email', 'gift-i-card'); ?>
            </th>
            <td>
                <label>
                    <input type="checkbox" name="gicapi_add_to_email" value="yes" <?php checked($add_to_email, 'yes'); ?>>
                    <?php esc_html_e('Add redeem data to order emails', 'gift-i-card'); ?>
                </label>
            </td>
        </tr>
        ...
        <tr>
            <th scope="row">
                <?php esc_html_e('Add to Order Details', 'gift-i-card'); ?>
            </th>
            <td>
                <label>
                    <input type="checkbox" name="gicapi_add_to_order_details" value="yes" <?php checked($add_to_order_details, 'yes'); ?>>
                    <?php esc_html_e('Add redeem data to order details page', 'gift-i-card'); ?>
                </label>
            </td>
        </tr>
        ...
        <tr>
            <th scope="row">
                <?php esc_html_e('Add to Thank You', 'gift-i-card'); ?>
            </th>
            <td>
                <label>
                    <input type="checkbox" name="gicapi_add_to_thank_you" value="yes" <?php checked($add_to_thank_you, 'yes'); ?>>
                    <?php esc_html_e('Add redeem data to thank you page', 'gift-i-card'); ?>
                </label>
            </td>
        </tr>
    </table>
