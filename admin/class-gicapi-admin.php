...
class GICAPI_Admin
{
    ...
    public function enqueue_scripts()
    {
        ...
        $script_params = array(
            ...
            'manual_update_orders_nonce' => wp_create_nonce('gicapi_manual_update_orders'),
            'manual_sync_products_nonce' => wp_create_nonce('gicapi_manual_sync_products'),
            'reschedule_cron_nonce' => wp_create_nonce('gicapi_reschedule_cron'),
            'check_repair_cron_nonce' => wp_create_nonce('gicapi_check_repair_cron'),
            'add_mapping_nonce' => wp_create_nonce('gicapi_add_mapping'),
            'remove_mapping_nonce' => wp_create_nonce('gicapi_remove_mapping'),
            'create_simple_product_nonce' => wp_create_nonce('gicapi_create_simple_product'),
            'create_variable_product_nonce' => wp_create_nonce('gicapi_create_variable_product'),
            ...
            'text_search_product' => __('Search for a product...', 'gift-i-card'),
            'text_select_product' => __('Please select a product', 'gift-i-card'),
            'text_error_mapping' => __('Error adding mapping', 'gift-i-card'),
            'text_confirm_remove' => __('Are you sure you want to remove this mapping?', 'gift-i-card'),
            'text_error_removing' => __('Error removing mapping', 'gift-i-card'),
            'text_confirm_create_product' => __('Are you sure you want to create a simple product for this variant?', 'gift-i-card'),
            'text_error_creating_product' => __('Error creating simple product', 'gift-i-card'),
            'text_error_creating_variable_product' => __('Error creating variable product', 'gift-i-card'),
            'text_product_name_required' => __('Product name is required', 'gift-i-card'),
            'text_product_sku_required' => __('Product SKU is required', 'gift-i-card'),
            'text_product_price_required' => __('Valid product price is required', 'gift-i-card'),
            'text_at_least_one_variant' => __('At least one variant must be selected', 'gift-i-card'),
            'text_variant_name_required' => __('Variant name is required for all selected variants', 'gift-i-card'),
            'text_variant_price_required' => __('Valid variant price is required for all selected variants', 'gift-i-card'),
            'text_loading_variants' => __('Loading variants...', 'gift-i-card'),
            'text_select_all' => __('Select All', 'gift-i-card'),
            'text_variant_name' => __('Name:', 'gift-i-card'),
            'text_variant_price' => __('Price:', 'gift-i-card'),
            'text_variant_value' => __('Value:', 'gift-i-card'),
            'text_variation_sku' => __('Variation SKU:', 'gift-i-card'),
            'text_placeholder_variation_sku' => __('e.g., VAR-001', 'gift-i-card'),
            'text_error_loading_variants' => __('Error loading variants.', 'gift-i-card'),
            'text_updating' => __('Updating...', 'gift-i-card'),
            'text_error_updating' => __('An error occurred while updating orders.', 'gift-i-card'),
            'text_update_orders' => __('Update Pending/Processing Orders Now', 'gift-i-card'),
            'text_syncing' => __('Syncing...', 'gift-i-card'),
            'text_error_syncing' => __('An error occurred while syncing products.', 'gift-i-card'),
            'text_sync_products' => __('Sync All Products Now', 'gift-i-card'),
            'text_rescheduling' => __('Rescheduling...', 'gift-i-card'),
            'text_error_rescheduling' => __('An error occurred while rescheduling cron job.', 'gift-i-card'),
            'text_reschedule_cron' => __('Reschedule Cron Job', 'gift-i-card'),
            'text_checking' => __('Checking...', 'gift-i-card'),
            'text_error_checking' => __('An error occurred while checking cron job.', 'gift-i-card'),
            'text_check_repair_cron' => __('Check & Repair Cron Job', 'gift-i-card')
        );
